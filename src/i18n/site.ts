...
export const siteCopy: Record<Locale, SiteCopy> = {
  ...
  es: {
    ...
    bio: [
      ...
      "Estudié mecatrónica en el Tecnológico de Monterrey y un MSc in Artificial Intelligence with Distinction en Essex. Trabajo en IA generativa en SAP — 1.er lugar en Innoweeks 2026 — y fundé ARMATUS, un coach de entrenamiento en iOS.",
    ],
    ...
    proof: [
      { label: "SAP Innoweeks", detail: "1.er lugar general · primer equipo mexicano", meta: "2026" },
