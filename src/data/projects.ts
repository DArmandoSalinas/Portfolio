...
export const projects: Project[] = [
  // ─────────────────────────── TIER A · FEATURED ───────────────────────────
  {
    ...
    repos: [
      { label: "ARMATUSWebPage", url: "https://github.com/DArmandoSalinas/ARMATUSWebPage" },
      { label: "ARMATUS-WEB-COACH", url: "https://github.com/DArmandoSalinas/ARMATUS-WEB-COACH" },
    ],
    live: [
  ...
  },
  {
    ...
    hook: "Interpretable motor health from vibration and temperature — live.",
    body: "A Sumitomo three-phase motor and a Haas Mini Mill stream over serial into machine-specific baselines. Adaptive z-score and temperature-slope thresholds produce 0–100 health scores in a Streamlit dashboard with a replay mode. Rule-based on purpose: every alarm can be traced to the rule that fired it.",
    categories: ["Predictive Maintenance"],
    metrics: [
      { value: "0–100", label: "health score" },
      { value: "2", label: "machines baselined" },
      { value: "100%", label: "interpretable rules" },
    ],
    stack: ["Python", "Streamlit", "Signal processing", "IoT / serial"],
...
export const earlierWork: { group: string; items: EarlierItem[] }[] = [
  {
    ...
    items: [
      ...
      {
        title: "Heart",
        body: "Heart-health follow-up tool. Early stage.",
        url: "https://github.com/DArmandoSalinas/Heart",
        tag: "Early",
      },
    ],
  },
